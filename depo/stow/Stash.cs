...
*/
	...
	interface StatshI {
		/*
		 *  new files you have are not added to the index (they are new files) and are not being tracked, and they wouldnot be stashed
		 *  
		 ...
		 * 
		 * 
		 git add -N . to add the files to the index. I also tried your git update-index --really-refresh command, but that didn't make the error go away.
