...
namespace nilnul.fs.git._module.work._ignore.div.doc.patch_._nilnul.file
{
	/// <summary>
	...
	static public class _NilnulX
	{
		static public void OfSpear(string spear)
		{
			...
			///those not exist
			var lines2patch = _ignore.div.doc.patch_._nilnul._RulesX.Enumerate().Where(
