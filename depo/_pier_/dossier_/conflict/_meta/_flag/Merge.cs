...
namespace nilnul.fs.git.depo._pier_.dossier_.conflict._meta._flag
{
	...
	/// ( merge.conflictStyle set to diff3, so  all three versions in the work-tree file are named file here.)
	///
	/// </remarks>
	///
	///stackoverflow.com/questions/49474035/is-there-multiple-files-stored-in-the-stage-after-git-add/49474111
