...
namespace nilnul.dev._git.git._module.module.cfg.remote.url.forPush
{
	class Set
	{
		/*
...
git remote set-url --push origin git@bitbucket.org:{new team or account name}/{repository name}.gi
