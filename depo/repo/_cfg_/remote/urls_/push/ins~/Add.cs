...
git remote set-url origin --push --add user2@repo2
			 ...
			 */
		static public void ByRemoteSetUrl(Folder folder, string remote, string url, Git git=null) {
			nilnul.win.prog_.git.run.result._ThrowErrX.Void(folder, $"remote set-url --add {remote} {url}",git);
