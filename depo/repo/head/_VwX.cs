...
namespace nilnul.fs.git.module.repo.current
{
	...
	static public class _VwX
	{
		...
		{
			var r= current_.refer._Vw_bySymbolicRefX._Result_addressAssumeModule(top,git);
			if (r.beErr)
			{
				return current_.reified.snap._Vw_byRevParseX._Txt_0depo(top, git);
			}
			return r.msg?.Trim();
		}
		...
		public static string Txt(ModuleI top, Git git=null)
		{
			...
			return _Txt_0depo(
				top.top1.en.address.en.ToString()
				,
				git
			);
