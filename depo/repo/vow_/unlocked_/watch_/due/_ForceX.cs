...
namespace nilnul.fs.git.depo.repo.vow_.unlocked_.watch_.due
{
	/// <summary>
	/// </summary>
	///
	static public class _ForceX
	{
		static public  Task  _AsTask_0depo(
			...
			return fs.git.repo.vow_.unlocked_.watch_.due._ForceX._Asyn_0repo(
