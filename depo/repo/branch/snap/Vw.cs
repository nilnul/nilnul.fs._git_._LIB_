...
namespace nilnul.fs.git.module.repo.branch.snap
{
	...
	static public class _VwX
	{
		...
		{
			return nilnul.os.prog_.git.run_.exit_.onDue._ResultX.Result(module, $"rev-parse {branch}", git, timeout_milliseconds??5000);
		}
		...
		public static string MsgTrimmed(ModuleI module, _branch.Name branch, Git git	,
			int? timeout_milliseconds=null
)
		{
			return  Msg(module,branch,git,timeout_milliseconds).Trim();
		}
