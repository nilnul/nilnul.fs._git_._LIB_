...
namespace nilnul.fs.git.module.repo.current_.reified.snap
{
	...
	/// 
	/// </summary>
	static public class _Vw_byRevParseX
	{
		/// <summary>
		/// 
		/// </summary>
		...
		public static string _Txt_0depo(string top, Git git)
		{
			return nilnul.os.prog_.git.run_.exit_.onDue.result._MsgX._Msg_0address4folder( top, "rev-parse @" ,git)?.Trim();
