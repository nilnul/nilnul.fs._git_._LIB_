...
namespace nilnul.fs.git.depo.repo.head_.refer._vw_.by_
{
	/*git symbolic-ref */

	//[Obsolete("if head is detached, fatal: ref HEAD is not a symbolic ref")]

	/// <summary>
	/// <see cref="fs.git.depo.repo.branch_.current._VwX"/>
	/// </summary>
	static public class _BySymbolicRefX
	{
		...
		///		note the head content is: ref: refs/heads/master; but the displayed is without the leading "ref: "
		...
		public static os.proc_.finished._result.CodMsgErr _Result_0depo(string top, Git git=null)
		{
		...
		{
			return _Result_0depo(top.ToString(), git);
		}

		public static string _Txt_0depo(string top, Git git=null)
		{
			return nilnul.os.proc_.finished._result.data._MsgX.Msg(
				_Result_0depo(top,git)
			);
		}
