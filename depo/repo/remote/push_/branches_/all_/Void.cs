...
Works like git push <remote>, where <remote> is the current branch’s remote (or origin, if no remote is configured for the current branch).
		...
		static public void Void_ofAddress(string workingDir, string remote, nilnul.win.prog_.Git git = null)
		{
			nilnul.win.prog_.git.run.result._Void_throwErrX.OfAddress(workingDir, "push --all " + remote, git);
		}
