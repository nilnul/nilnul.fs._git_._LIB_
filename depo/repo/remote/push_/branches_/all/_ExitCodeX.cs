...
namespace nilnul.fs.git.module.repo.push_.remote.branches_.all
{
	/// <summary>
	/// all branches
	/// </summary>
	static public class _ExitCodeX
	{
		...
		{
			return nilnul.win.prog_.git.run._ExitCodeX.ExitCode(workingDir, "push --all " + remote,git);    //all here means all branches.
		}
