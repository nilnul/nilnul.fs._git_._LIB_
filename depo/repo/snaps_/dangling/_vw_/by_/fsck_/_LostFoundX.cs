...
namespace nilnul.fs.git.depo.repo.snaps_.dangling._vw_.by_.fsck_
{
	/*
	 lukescott.co/2019/05/10/git-finding-lost-dangling-commits/
	...
	internal class _LostFoundX
	{
		...
		)
		{
			...
			return nilnul.os.prog_.git.run_.exit.result._MsgX._GetMsg_0depo_1argument(
				...
				$"fsck --lost-found"    ///  To find lost (dangling) commits, use fsck:
										/// git fsck --lost-found
