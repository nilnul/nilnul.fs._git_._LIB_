...
namespace nilnul.fs.git.module.branch_.current
{
	/// <summary>
	...
	static public class _PullX
	{
		...
		static public void Pull_assumeRemoteIsDefault4currentBranch(nilnul.fs.Folder folder, string remote, nilnul.win.prog_.Git git=null)
		{
		...
		/// <summary>
		/// get the same branch from remote
		/// </summary>
		/// <param name="folder"></param>
		/// <param name="remote"></param>
		/// <param name="git"></param>
		...
		{
			nilnul.fs.git.module.branch_.current.pull_._RemoteBranchX.Pull(
