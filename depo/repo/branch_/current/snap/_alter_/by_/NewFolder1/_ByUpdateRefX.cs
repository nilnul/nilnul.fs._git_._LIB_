...
{
	[Obsolete(nameof(nilnul.fs.git.depo.repo.branch_.current.snap._alter_.by_._ByUpdateRefX))]
	static public class _ByUpdateRefX
	{
		...
		///	, for the above two cases,  whence git updates not the HEAD, but the branch's content. <see cref="branch_.current.assign_"/>
		/// </param>
