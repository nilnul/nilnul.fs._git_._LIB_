...
namespace nilnul.fs.git.depo.pier.vs_._head_.by_
{
	/// <summary>
	/// git diff --cached
	/// 
	...
	/// </summary>
	/// "--cached" means the pier. the basis is implicit:the one before the pier, that is: the head snapshot <see cref="repo.snap_.current"/>;
	/// <see cref="fs.git.depo.werk.vs_.Index"/>
	class Diff
	{
