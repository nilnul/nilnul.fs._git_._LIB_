...
namespace nilnul.fs.git.module.staged.be_.empty_
{
	/// <summary>
	/// nothing to commit
	/// </summary>
	...
	public class DryRun
	{
		...
		{
			var result = nilnul.win.prog_.git.run._ResultX1._Result_0address_1argument(    //note: errCode is 1.
				gitTop, "commit --dry-run --short",git
			);
