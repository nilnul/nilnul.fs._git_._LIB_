...
{
	[Obsolete(nameof(nilnul.fs.git.module.repo.commits._InsX))]
	static public class _InsX
	{
		...
		static public void AddAll_Commit( string module, string commitMsg)
		{
		...
		static public void Ins(nilnul.win.prog_.Git git,string workingDir, string commitMsg)
		{
		...
		static public void Ins(nilnul.fs.Folder workingDir, string commitMsg)
		{
