...
namespace nilnul.fs.git.child.be_
{
	/// <summary>
	/// </summary>
	public class Work
	{
		...
		static public bool _RepoFalse(Git git, string _rootChildFolder_Location)
		{
		...
		static public bool _Eval(Git git, string _rootChildFolder_Location)
		{
		...
		{
			return _RepoFalse(Git.StaticInstance, _rootChildFolder_Location);
		}
