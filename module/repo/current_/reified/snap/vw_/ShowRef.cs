...
namespace nilnul.fs.git.module.repo.current_.reified.snap.vw_
{
	/*git show-ref */

	[Obsolete("a list of remarked snap")]
	static public class _ShowRefX
	{
		...
		/// <returns>
		/// for unborn branch, the err is empty, the msg is empty,  but the cod is 1;
		/// 
		...
		///
		/// eg:
		///   e68754bc99e42567ecd1e5d58d2bc94fcc90c73c HEAD		e68754bc99e42567ecd1e5d58d2bc94fcc90c73c refs/heads/master
		/// </returns>
