...
namespace nilnul.fs.git.module.repo.push_.remote.branches_.all.exitCode
{
	static public class _TaskX
	{
		...
		{
			return Task.Run( ()=>_ExitCodeX.Exe(workingDir,remote,git)); 
		}
		...
		{
			return Task.Run( ()=>_ExitCodeX.Exe(workingDir,remote,git),cancel); 
		}
