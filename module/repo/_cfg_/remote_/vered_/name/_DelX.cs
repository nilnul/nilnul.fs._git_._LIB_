...
namespace nilnul.fs.git.module.repo._cfg_.remote_.vered_.name
{
	...
	static public class _DelX
	{
		...
		public static void _Exe_moduleAddress(string _module_address, string name, nilnul.win.prog_.Git git =null)
		{
			Exe(  nilnul.fs.folder_.git_.Top.FroAddress(_module_address) ,name, git);
