...
namespace nilnul.dev.git.module.branches_.seeded
{
	...
	public class Current
	{
		...
		/*
		 symbolic-ref --short HEAD
			 */
		static public string GetCurrentBranch_SymbolicRef__retNullIfNo(nilnul.win.prog_.Git git, string workingDir)
		{
			return nilnul.win.prog_.git.run.result._MsgOrNul4errX.OfAddress(workingDir, "symbolic-ref --short HEAD");
