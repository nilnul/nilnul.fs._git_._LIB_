...
namespace nilnul.fs.git.svr_.bitBucket.client.prjs
{
	public class Add
	{

		private svr_.bitBucket.Client _svr;

		public svr_.bitBucket.Client svr
		{
			get { return _svr; }
			set { _svr = value; }
		}

		public Add(svr_.bitBucket.Client svr)
		{
			_svr = svr;
		}
