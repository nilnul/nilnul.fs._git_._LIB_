...
namespace nilnul.dev.git.svr_.vs.repos
{
	public class Get
	{

		public static async Task<string> GetReposAsync(string account, string token)
		{
			...
			try
			{
				...
				var gitNewUrl = VisualStudio.GenerateUrl1_0(account, workingArea);
