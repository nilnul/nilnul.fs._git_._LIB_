	...
	//Microsoft.Azure.DevOps.ClientSamples.ProjectsAndTeams
{
		...
		//: ClientSample
	{
		...
		public LibConsumer(nilnul.fs.git.svr_.vs.Client clientAzure)
		{
		...
		public LibConsumer(string org, string token):this(
new nilnul.fs.git.svr_.vs.Client(org,token)
		)
		{

		}
		public LibConsumer():this(
 nilnul.fs.git.svr_.vs.Client.CreateFroVault()
		)
		{
		...
		/// <summary>
		/// set this before calling methods that needs this
		/// </summary>
		public string org;
		/// <summary>
