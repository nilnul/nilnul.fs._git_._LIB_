...
namespace nilnul.fs.git.repo.snap.rel_.parent._vw_.by_
{
	/// <summary>
	/// 
	/// </summary>
	/// <see cref="fs.git.depo.repo.snap.rel_.parent._VwX._Msg_0depo(string, os.prog_.Git)"/>
	static public class _LogX
	{
		...
		)
		{
			...
			return nilnul.os.prog_.git.run_.exit.result._MsgX._GetMsg_0depo_1argument(
					...
					$"log {
						"--pretty=%H:%P"		/// H:full hash; P: parents separated by space
					} {
