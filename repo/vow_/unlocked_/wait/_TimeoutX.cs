...
{
	[Obsolete(nameof(fs.git.repo.vow_.unlocked_.wait_._TimeoutX))]
	static public class _TimeoutX
	{
		...
		static public void _Timeout_addressAssumeRepo(string address, int totalTime = 30 * 1000, int interval = 2 * 1000)
		{
