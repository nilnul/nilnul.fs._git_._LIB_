...
namespace nilnul.win.prog_
{
	...
	public class Git
	{
		...
		static public implicit operator nilnul.os.prog_.Git(Git g) {
			return g is null?null: new os.prog_.Git(g.location);
		}

		static public implicit operator nilnul.win.prog_.Git(os.prog_.Git g) {
			return g is null?null:new Git(g.location);
		}
