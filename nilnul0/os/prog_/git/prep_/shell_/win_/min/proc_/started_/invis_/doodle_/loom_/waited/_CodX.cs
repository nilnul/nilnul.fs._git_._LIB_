...
namespace nilnul.os.prog_.git.prep_.shell_.win_.min.proc_.started_.invis_.doodle_.loom_.waited
{
	static public class _CodX
	{
		...
		{
			return _Cod_ofCmd9argument9dir(git.location.ToString(),args,dir,lurk);
		...
		{
			return _Cod_ofCmd9argument9dir( nilnul.os.prog_.git.nulable.Fallback.NotNul(),  args,module,lurk_assumeNum);
