...
namespace nilnul.os.prog_.git.run_.exit.result
{
	...
	/// </summary>
	/// <remarks>
	/// for timeout one, <see cref="os.prog_.git.run_.due.result._MsgX"/>
	///
	/// </remarks>
	/// 
	public class _MsgX
	{
		public static string _GetMsg_0depo_1argument(
			string module,
			string arg,
			nilnul.win.prog_.Git git = null
			)
		{
			return nilnul.os.proc_.finished._result.data._MsgX.Msg(nilnul.os.prog_.git.run_.exit._ResultX._Result_0address_1argument(
				module
				,
				arg
				,
		...
		{
			return nilnul.os.proc_.finished._result.data._MsgX.Msg(nilnul.os.prog_.git.run_.exit._ResultX.Result(
				module
				,
				arg
				,
