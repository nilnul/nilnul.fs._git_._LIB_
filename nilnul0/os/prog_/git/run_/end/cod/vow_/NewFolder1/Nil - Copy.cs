...
namespace nilnul.win.prog_.git.run.exitCode.vow_
{
	...
	[Obsolete(
		nameof(nilnul.win.prog_.git.run.cod.vow_._NilX)
	)]
	public class _NilX
	{


		public static void _Vod_0address_1argument_2xpn(
			string module,
			string arg,
			string xpn
			,
		...
		)
		{
			new nilnul.num.integer_.int32.be_.nil.Vow(xpn).vow(
				_ExitCodeX._Cod_0address_1argument(module, arg, git)
			);
		}
		...
		public static void _Vod_addressOfModule_ofArgs(string module, params string[] args)
		{
			 nilnul.num.integer_.int32.be_.nil.Vow.Singleton.vow(
				_ExitCodeX._Cod_0address_1args(module, args)
			);

		}

		public static void _Vod_0address_2args(string module,nilnul.os.prog_.Git git, params string[] args)
		{
			 nilnul.num.integer_.int32.be_.nil.Vow.Singleton.vow(
				_ExitCodeX._Cod_0address_2args(module,git, args)
			);
