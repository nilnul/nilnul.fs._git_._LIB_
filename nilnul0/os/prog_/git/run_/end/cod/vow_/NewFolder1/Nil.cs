...
namespace nilnul.win.prog_.git.run.cod.vow_
{
	...
	[Obsolete(nameof(nilnul.os.prog_.git.run_.exit.cod.vow_._NilX))]
	public class _NilX
	{
		...
		public static void _Vod_0address_1argument(string module,  string args, nilnul.win.prog_.Git git=null)
		{
			 nilnul.num.integer_.int32.be_.nil.Vow.Singleton.vow(
				run._CodX._ExitCode_ofAddress(module, args,git)
			);
