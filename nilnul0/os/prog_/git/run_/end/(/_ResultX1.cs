...
namespace nilnul.win.prog_.git.run
{
	...
	{
		static public os.proc_.finished._result.CodMsgErr _Result_0address_1argument(
			string shield
			,
			string arg
			,
		...
		{
			return os.prog_.git.run_.exit._ResultX._Result_0address_1argument
				(
				shield,
		...
		{
			return os.prog_.git.run_.exit._ResultX._Result_assumeAddress
