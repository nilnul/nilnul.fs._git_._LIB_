...
namespace nilnul.fs.git.folder.categorize_
{
	/// <summary>
	/// 
	/// </summary>
	public class PlainWorkRepo
	{
		...
		static public _plainWorkRepo.Ret _Eval(Git git, string folder)
		{
		...
		static public _plainWorkRepo.Ret _Eval(Git git, nilnul.fs.Folder folder)
		{
			//StringWriter output = new StringWriter();
