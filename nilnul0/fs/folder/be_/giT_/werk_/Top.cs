...
namespace nilnul.fs.folder.be_.giT_.werk_
{
	/// <summary>
	/// work or repo
	/// </summary>
	...
	/// </remarks>
	public class Top : nilnul.fs.folder.BeI
		//,
		//nilnul.fs.folder._be_.

		//,nilnul.fs.folder.BeI2
	{
		//[Obsolete()]
		...
		//{
		//	return be_.git_.Work.Singleton._be_0folder(obj) 
		//		&& 
