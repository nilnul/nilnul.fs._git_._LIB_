...
namespace nilnul.fs.folder_.nonlink_.git_.work.git_.modules_.nonlink_
{
	...
	static public class _InsideX
	{
		public static IEnumerable<DivI> _Divs(nilnul.fs.FolderI _work_nonlink, Git git=null)
		{
			...
			{
				return  nilnul.fs.folder_.nonlink_.git_.work_.top.git_.modules_.nonlink_._InsideX._Divs(_work_nonlink,git);
			}
			else
			{
				return nilnul.fs.folder_.nonlink_.git_.work_.nontop.git_.modules_.nonlink_._InsideX._Divs(_work_nonlink, git);
			}
